package com.example.felixits.imagesliderdemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (bundle.getString("anim")) {
            case "Card Stack":slider.setPageAnimation(ImageSlider.PageAnimation.CARD_STACK); break;
            case "Parallax":slider.setPageAnimation(ImageSlider.PageAnimation.PARALLAX); break;
            case "Fade":slider.setPageAnimation(ImageSlider.PageAnimation.FADE); break;
        }
